        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/contestants" className="text-gray-400 hover:text-white">
                  {t('footer.quickLinks.contestants')}
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">
                {t('footer.contact.email')}: info@missstar.com
              </li>
              <li className="text-gray-400">
                {t('footer.contact.phone')}: +1 (555) 123-4567
              </li>
              <li className="text-gray-400">
                {t('footer.contact.address')}: 123 Beauty Street, Miami, FL
              </li>
            </ul>
          </div>
